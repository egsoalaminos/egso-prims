    ...
    <>
      ...
      >
        ...
        <div className="min-w-0 flex-1 text-left group-data-[collapsed=true]:hidden">
          <div className="truncate text-body font-semibold text-neutral-800">{name}</div>
          {detail && <div className="truncate text-micro text-neutral-500">{detail}</div>}
        </div>
      ...
      <div className="mt-1 grid grid-cols-2 gap-1 group-data-[collapsed=true]:hidden">
        <button
          onClick={onSettings}
          className="flex items-center justify-center gap-1 rounded-md px-2 py-1 text-micro text-neutral-600 transition hover:bg-neutral-50"
        >
