  ...
  return (
    <div className="min-h-screen bg-canvas font-sans antialiased">
      ...
      <header className="sticky top-0 z-20 border-b border-neutral-200 bg-white/85 backdrop-blur">
        ...
        {/* Until this existed the portal had no navigation at all: every inner
            page could only be left through the logo. */}
        <nav aria-label="Portal services" className="border-t border-neutral-200 bg-white">
          <ul className="mx-auto flex max-w-6xl gap-1 overflow-x-auto px-3 py-1.5 text-[12.5px]">
